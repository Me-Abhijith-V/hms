...
if (isset($_POST['apply'])) {
  ...
  $error = array(); 	
	...
	if(empty($firstname)) {
		...
		$error['apply'] = "Enter Blood Group";
	}


	if(count($error)==0){

		$query = "INSERT INTO patient(firstname,surname,username,email,gender,phone,country,password,date_reg,profile,blood_group) VALUES('$firstname','$surname','$username','$email','$gender','$phone','$country','$password',NOW(),'','$blood')";
		...
		<div class="row">
          ...
          <h5 class="">APPLY NOW</h5>
            ...
            <label>Blood Group</label>
						<input type="text" name="bgrp" class="form-control" autocomplete="off" placeholder="Enter Blood Group" value="<?php if(isset($_POST['bgrp'])) echo $_POST['bgrp']; ?>">
