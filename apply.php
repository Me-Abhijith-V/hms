...
if (isset($_POST['apply'])) {
  ...
  $error = array(); 	
	...
	if(count($error)==0){
		...
		$query = "INSERT INTO doctors(firstname,surname,username,email,gender,phone,country,password,salary,data_reg,status,profile,specialization,experience) VALUES('$firstname','$surname','$username','$email','$gender','$phone','$country','$password','0',NOW(),'Pendding','','$special','$exp')";
	...
	<div class="col-md-12">
        ...
        <div class="login">
            ...
            <label>Specialization</label>
						<input type="text" name="special" class="form-control" autocomplete="off" placeholder="Enter Specialization" value="<?php if(isset($_POST['special'])) echo $_POST['special']; ?>">

            <label>Experience (In Years)</label>
						<input type="number" name="exp" class="form-control" autocomplete="off" placeholder="Enter Experience" value="<?php if(isset($_POST['exp'])) echo $_POST['exp']; ?>">
                ...
                <option value="Zimbabwe">Zimbabwe</option>
					...
					<input type="submit" name="apply" value="Apply Now" class="login_bt">
					<p style="padding-bottom: 30px;">I already have an account<a href="doctorlogin.php"> Login Now</a> </p>
				</form>
			</div>
			</div>
			<div class="col-md-3">
